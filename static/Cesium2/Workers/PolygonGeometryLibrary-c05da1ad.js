 ...
 */
define(['exports', './when-a55a8a4c', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './ComponentDatatype-919a7463', './GeometryAttribute-6a634ea4', './PrimitiveType-97893bc7', './Transforms-5ec531c4', './GeometryAttributes-1c7ce91d', './GeometryPipeline-42d27b2d', './IndexDatatype-18a8cae6', './arrayRemoveDuplicates-aafa59fd', './ArcType-66bc286a', './EllipsoidRhumbLine-ff66f54b', './PolygonPipeline-33832221'], function (exports, when, _Math, Cartesian2, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, GeometryPipeline, IndexDatatype, arrayRemoveDuplicates, ArcType, EllipsoidRhumbLine, PolygonPipeline) { 'use strict';
